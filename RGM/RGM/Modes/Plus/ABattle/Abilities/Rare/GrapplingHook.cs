...
[Ability("갈고리", "지급된 동전을 튕기면 대상을 끌어옵니다. (사거리 7)", AbilityCategory.Rare, AbilityType.RARE_GRAPPLINGHOOK)]
public class GrapplingHook : Ability
{
    ...
    public void OnFlippingCoin(FlippingCoinEventArgs ev)
    {
        ...
        {
            if (Tools.TryGetLookPlayer(ev.Player, 7f, out Player target, out RaycastHit? hit))
            {
