...
[Ability("치명적인 바이러스", "SCP들에게 [<color=#ffd700>전설</color>] 상급 변이 능력을 3 ~ 4개와 [<color=#FF00FF>영웅</color>] 변이 능력을 10 ~ 12개 지급합니다. ", AbilityCategory.Mythic, AbilityType.MYTHIC_SCP079_SEVEREVIRUS, RoleAbility.Scp079)]
