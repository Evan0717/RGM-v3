...
[Ability("가호", "자신을 포함한 SCP들에게 [<color=#FF00FF>영웅</color>]럭키비키, [일반] 행운 능력을 지급합니다.(79는 럭키비키만 지급)", AbilityCategory.Epic, AbilityType.EPIC_SCP079_BLESSING, RoleAbility.Scp079)]
