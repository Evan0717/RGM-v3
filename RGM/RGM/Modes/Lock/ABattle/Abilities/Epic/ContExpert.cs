...
[Ability("격리 전문가", "SCP 개체에 가하는 데미지가 95% 증가합니다(999, 035는 제외).", AbilityCategory.Epic, AbilityType.EPIC_CONTEXPERT)]
public class ContExpert : Ability
{
    ...
    public void OnHurting(HurtingEventArgs ev)
    {
        ...
        ev.DamageHandler.Damage *= 1 + 0.95f * Owner.AbilityCount(AbilityType.EPIC_CONTEXPERT);
    }
}