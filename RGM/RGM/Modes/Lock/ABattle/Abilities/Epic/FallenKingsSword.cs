...
[Ability("몰락한 왕의 검", "공격 시 대상 최대 HP의 1.8%만큼 추가 데미지를 입힙니다. 대상이 인간진영인 경우 12.6%로 적용됩니다.", AbilityCategory.Epic, AbilityType.EPIC_FALLENKINGSSWORD)]
public class FallenKingsSword : Ability
{
    ...
    public void OnHurting(HurtingEventArgs ev)
    {
        ...
        float ratio = ev.Player.IsScpRole() ? 0.018f : 0.126f;
