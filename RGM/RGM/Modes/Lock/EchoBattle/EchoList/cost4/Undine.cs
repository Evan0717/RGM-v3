...
[Echo("운디네", "사용 시 주변 15m 내에 있는 모든 상대 2초간 40% 감속 및 Sinkhole 효과 부여, 재사용 대기시간 40초", EchoType.Undine, EchoCost.Cost4, EchoMainStatType.HpPercent, "💧")]
public class Undine : EchoActiveAbility
{
    public override float Duration => 2f;
    public override float Cooldown => 40f;
    public override string ActiveDescription => "주변 15m 적 2초간 40% 감속 및 Sinkhole 효과 부여";
